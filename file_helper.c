/* DIGITAL SIGNATURE(S):
   ...
   3) Gerardo Arturo Rodriguez  garodriguez-cardenas@myseneca.ca
...
/********************************************************/
double readTime(FILE* fp) //function prototype is not needed for this as it is being called before readFileRecord
{
	int hour, min;
